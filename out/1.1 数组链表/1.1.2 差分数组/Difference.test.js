...
var _this = this;
describe('数组链表', function () {
    it('p43 差分数组 核心代码', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('p45 差分数组 370题 区间加法', function () { return __awaiter(_this, void 0, void 0, function () {
        var L370, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./Difference'); })];
    ...
    it('p45 差分数组 1109题 航班预订统计', function () { return __awaiter(_this, void 0, void 0, function () {
        var L1109, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./Difference'); })];
    ...
    it('p45 差分数组 1094题 拼车', function () { return __awaiter(_this, void 0, void 0, function () {
        var L1094;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('./Difference'); })];
